...
\textbf{Alcance de este manuscrito.} El plan que sigue describe an\'alisis
\emph{previstos}: el experimento no se ha ejecutado y el documento no contiene
puntuaciones, resultados ni discusi\'on. Ninguna de las decisiones descritas en
esta secci\'on se ha tomado a la vista de datos observados. El registro p\'ublico
del protocolo tampoco equivale a un \emph{Registered Report} con aceptaci\'on en
fase~1, pues no hubo revisi\'on previa del dise\~no por parte de una revista; se
trata de una vista previa de investigaci\'on prerregistrada. El estado del estudio
y los compromisos de reporte se detallan en la secci\'on~\ref{sec:estado}.
