...
%  Se incluye desde ERS_SRS_2B_v2.0.tex mediante \input{seccion4_uml}
...
\hline
\textbf{Requisitos} & \id{RF-16}, \id{RF-17}, \id{RF-19}, \id{RF-20}, \id{RF-26} \\ \hline
...
\textbf{Flujo alternativo C} & \emph{Reporte de desempeño e historial.} El sistema presenta el indicador de desempeño por persona (\id{RF-16}), el historial de actividades y eventos del lote (\id{RF-20}) y la información climática asociada al período (\id{RF-17}). \\ \hline
...
% ---------------------------------------------------------------------
%  CU-11 a CU-18 --- especificados en la PE5 para cerrar la métrica M1b
% ---------------------------------------------------------------------
\noindent
Los ocho casos de uso que siguen existían como nodo del diagrama general desde la Entrega 2A, pero
carecían de especificación textual. La auditoría de calidad de la Unidad~V lo detectó al medir la
métrica M1b ---casos de uso especificados sobre casos de uso identificados---, que arrojaba un
55,6\,\% frente al 100\,\% exigido. Su especificación cierra esa brecha y, al hacerlo, completa el
eslabón de caso de uso de la cadena de trazabilidad para los requisitos que solo aparecían en el
diagrama.
