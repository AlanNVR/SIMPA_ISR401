...
\textbf{Registro previo} & Registro público en Open Science Framework (OSF): \url{https://osf.io/4z35d/} --- véase \id{osf\_registration.pdf} \\ \hline
\textbf{Estado} & Diseñado y registrado públicamente. \textbf{Ejecución pendiente} \\ \hline
\textbf{Versión} & 1.1 --- 31 de agosto de 2026 (actualización administrativa del registro OSF) \\ \hline
\end{longtable}
...
\medskip
\noindent\textit{Nota de versión.} La versión 1.1 incorpora únicamente la URL y
el estado administrativo del registro público OSF. No modifica la pregunta de
investigación, las hipótesis, las variables, la muestra, el procedimiento ni el
plan de análisis registrados.
