...
\id{ENTR-02} & Administrador / Asesor técnico & Palmicultora M & Primario & Alta & \id{EV-02} \\ \hline
...
\id{EV-13} & Hoja de liquidación semanal & 03--07/08/2026 & Palmicultora M & \id{RF-29}, \id{RF-36} a \id{RF-39} & [P] + [R] & N/A \\ \hline
...
\id{02\_Evidencias/Codificacion\_Tematica/}\allowbreak\id{codificacion.csv}, con las columnas Fragmento, Código,
...
La tabla completa de clasificación de los 35 requisitos funcionales, con su prioridad MoSCoW, su
...
documento presenta la vista reducida de sus 48 filas y el diagnóstico de cobertura correspondiente.
...
\hline
\endhead
\id{TR-XX} & Fila de la matriz de trazabilidad & \id{TR-01} a \id{TR-48} \\ \hline
...
\id{RF-XX} & Requisito funcional & \id{RF-01} a \id{RF-39} \\ \hline
\id{RNF-XX} & Requisito no funcional & \id{RNF-01} a \id{RNF-18} \\ \hline
...
\caption{Contribución de los integrantes del equipo en la Entrega 3 (2A)}
\end{longtable}
