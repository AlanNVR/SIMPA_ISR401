...
\id{RF-36} & Catálogo de tarifas por labor & --- & No implementado & --- \\ \hline
\id{RF-37} & Cálculo de la remuneración semanal & --- & No implementado & --- \\ \hline
\caption{Cobertura verificada del MVP sobre los 21 requisitos funcionales \emph{Must}}
\label{tab:mvp}
\end{longtable}

\noindent
\textbf{Cobertura alcanzada.} De los 21 requisitos funcionales \emph{Must} vigentes al momento de
construir el prototipo, 8 se encuentran implementados de forma completa, 2 de forma parcial y 2 en
estado simulado. La cobertura efectiva sobre ese conjunto es de $8/21 = 38{,}1\%$, o de
$9/21 = 42{,}9\%$ contabilizando las implementaciones parciales con peso medio. Sobre el catálogo
posterior al Change Control Board, que eleva los \emph{Must} a 24 con la incorporación de
\id{RF-40} a \id{RF-42}, la cobertura desciende a $8/24 = 33{,}3\%$. Se declaran ambos
denominadores: el primero mide el prototipo contra el alcance que tenía cuando se construyó; el
segundo, contra el alcance vigente.

\noindent\fbox{\parbox{0.97\textwidth}{\small\textbf{Nota de corrección (v3.1).} La versión 3.0
declaraba una cobertura de $9/19 = 47{,}4\%$. Ese cálculo incorporaba en el numerador a \id{RF-20}
(implementado) y a \id{RF-15} (parcial), que sus fichas de la §3.2 clasifican como \emph{Should}, y
omitía del denominador a \id{RF-36} y \id{RF-37}, que son \emph{Must}. Depurado el conjunto, la
cobertura real es menor que la declarada. Se corrige a la baja en lugar de conservar la cifra más
favorable.}}
...
\id{L-10} & El prototipo alcanza una cobertura del 38{,}1\% de los 21 requisitos \emph{Must}, por debajo del 60\% exigido por la §3.6 de la guía. & Se declara el valor real verificado por inspección del código, sin computar las funcionalidades simuladas como implementadas. Plan de incorporación en la §7.5. \\ \hline
