...
|---|---|---|
| Exportación del cuestionario aplicado (62 respuestas) | `02_Evidencias/Cuestionario/Respuestas/Sistema Inteligente de Mantenimiento de Palma Africana(1-62).xlsx` | Exportación directa de Google Forms, intacta |

No se copia aquí para evitar dos originales del mismo archivo. Su transformación
