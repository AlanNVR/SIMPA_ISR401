...
del equipo, el proyecto se migró inicialmente a un repositorio nuevo sin historial de Pull Requests, identificado como
\texttt{SIMPA\_ISR401} bajo la cuenta \texttt{AlanNVR}. El repositorio anterior quedó archivado en modo privado. Posteriormente, el repositorio fue transferido al docente y su URL canónica vigente es \url{https://github.com/gleiston-guerrero/SIMPA_ISR401}.
