...
**Decisión ratificada:** ampliar el enunciado e incorporar la distinción al tratamiento de las
...
**Decisión ratificada, con corrección respecto de la propuesta inicial.** La propuesta original —«ampliar incorporando el criterio diferenciado por variedad»— describía incorrectamente la acción necesaria: ese criterio ya existe en la especificación. El requisito \id{RF-10} y su criterio de aceptación \id{CA-08} fijan un umbral de 3 frutos desprendidos para la variedad \emph{guineensis} y de 5 para la variedad híbrida.

**La acción efectiva es verificar el umbral vigente, no incorporarlo.** La precisión de ENTR-02 sitúa el corte de la variedad híbrida entre cuatro y seis frutos desprendidos, y la madurez plena a partir de seis. El umbral especificado de 5 se encuentra dentro de ese rango, por lo que no existe contradicción frontal; sin embargo, si la madurez plena se alcanza a partir de seis, un umbral de cinco podría clasificar como maduro un racimo que no ha alcanzado ese estado.

En consecuencia se acuerda:

1. Contrastar el umbral de \id{CA-08} para la variedad híbrida con la precisión aportada, y tramitar su revisión mediante solicitud de cambio si procede.
...
| Caso | Enunciado | Decisión ratificada | Responsable |
|---|---|---|---|
| D-01 | 1 | Reformular con delimitación de alcance | Villafuerte Rosero Allan Noe |
| D-02 | 2 | Conservar y reportar la discrepancia | Huilcapi León Denisses Fabiola |
| D-03 | 7 | Reformular como barrera condicionada | Huilcapi León Denisses Fabiola |
| D-04 | 8 | Reformular incorporando la gestión como variable | Villafuerte Rosero Allan Noe |
| D-05 | 10 | Reformular eliminando la atribución de desconfianza | Huilcapi León Denisses Fabiola |
| D-06 | 11 | Reformular por ambigüedad y declarar el defecto | Rizzo Vélez Edson Nagib |
| A-01 | 3 | Afinar el disparador de criticidad de \id{RF-12} por naturaleza de la incidencia | Macías Herrera Josthyn Esteban |
| A-02 | 9 | Verificar el umbral de \id{CA-08} para la variedad híbrida | Macías Herrera Josthyn Esteban |
...
—ratificar, modificar o rechazar la propuesta— y las tres se consideraron
válidas. La revisión previa al contraste con la especificación motivó la
corrección del caso A-02, cuya propuesta inicial describía incorrectamente la
acción necesaria.
 
**Trazabilidad de las acciones derivadas.** Cada decisión con impacto sobre los
requisitos se traslada a su artefacto correspondiente:
 
| Caso | Artefacto de destino |
|---|---|
| D-01, D-04 | Requisitos de registro de labores; posible solicitud de cambio |
| D-02 | Sección de amenazas a la validez del manuscrito |
| D-03 | Requisitos de usabilidad; converge con los hallazgos `H-05` y `H-06` del walkthrough |
| D-05 | Requisito de registro de datos climáticos, que el enunciado original contradecía |
| D-06 | Sección de amenazas a la validez del manuscrito, como defecto de instrumento |
| A-01 | Disparador de criticidad de `RF-12` |
| A-02 | Umbral de madurez de `CA-08`; posible solicitud de cambio |
 
**Convergencia con otras técnicas.** Las decisiones D-03 y D-06 encuentran
respaldo independiente en la validación por walkthrough: el hallazgo `H-05`
—ausencia de orientación sobre el flujo de trabajo— fue el más repetido de esa
ronda, y `H-06` recoge cuatro términos que detuvieron a participantes de perfiles
distintos. Que dos técnicas independientes, con participantes distintos,
converjan sobre la barrera de familiaridad refuerza esa interpretación más allá
de lo que sostendría cualquiera de las dos por separado.
 
**Limitación de la ratificación.** El equipo ratifica decisiones sobre la
interpretación de los datos, no sobre los datos mismos. Ninguna de estas
decisiones modifica lo declarado por los participantes, que consta íntegro en las
actas individuales y en el acta consolidada de la ronda.
